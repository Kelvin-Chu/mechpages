/*
 * Customized to make the radius marker bigger
 *
...
L.CircleEditor = L.Circle.extend ({
    ...
    _initMarkers: function () {
        ...
        var circleBounds = this.getBounds(),
            ...
            markerNorthCenter = this._createOuterMarker(northCenterCoord, 1);
    ...
    _createOuterMarker: function (latlng, index, isCenter) {
        var marker = new L.Marker(latlng, {
            draggable: true,
